...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("-Cantidad de localizadores vendidos: " + analizadorDeMetricas.getCantidadDeLocalizadoresVendidos());
        ...
        analizadorDeMetricas.dictionaryCantidadDeReservasPorTipo().forEach((k,v)-> System.out.println(
                "\t\t-"+k + ": "+v
        ));
