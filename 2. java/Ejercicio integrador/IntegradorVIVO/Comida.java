...
public class Comida implements RepositorioBase{
    protected RepositorioBase repositorio;
    protected int descuento = 0;
    public Comida(RepositorioBase repositorio) {
        this.repositorio = repositorio;
        this.repositorio.addLocalizador("Comida");
