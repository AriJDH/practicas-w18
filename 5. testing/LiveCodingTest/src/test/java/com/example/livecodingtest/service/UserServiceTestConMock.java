...
public class UserServiceTestConMock {
    ...
    @Test
    @DisplayName("US003 - crear un nuevo usuario - Camino Feliz :D")
    void crearUsuarioOkTest(){
        //Arrange
        UserDto userDto = new UserDto("Marcos","Aurelio",67);
        UserDto expected = new UserDto("Marcos","Aurelio",67);
        User userMock = new User("Marcos","Aurelio",67);
        when(userRepository.guardarUsuario(userMock)).thenReturn(userMock);
