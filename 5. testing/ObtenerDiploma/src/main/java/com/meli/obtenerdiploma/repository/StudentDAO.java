...
public class StudentDAO implements IStudentDAO {
    ...
    public void save(StudentDTO stu) {
        if (stu==null) throw new RuntimeException("No se permite un estudiante nulo");
    ...
    public StudentDTO findById(Long id) {
        return students.stream().filter(stu -> stu.getId().equals(id)).findFirst().orElseThrow(() -> new StudentNotFoundException(id));
    }
