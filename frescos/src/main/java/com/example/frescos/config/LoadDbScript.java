...
public class LoadDbScript {
    ...
    public void loadDb(){
        ...
        Batch batch4 = new Batch(4L, product4,5.00,-1.2,5231,4002,LocalDate.of(2021,6,23), LocalDateTime.of(LocalDate.of(2021,6,23), LocalTime.now()), LocalDate.now().plusDays(30));
        Batch batch5 = new Batch(5L, product5,5.00,-1.2,1489,807,LocalDate.of(2022,10,4), LocalDateTime.of(LocalDate.of(2022,10,4), LocalTime.now()), LocalDate.now().plusDays(30));
        Batch batch6 = new Batch(6L, product6,4.00,-5.0,3210,1201,LocalDate.of(2022,9,30), LocalDateTime.of(LocalDate.of(2021,9,30), LocalTime.now()), LocalDate.now().plusDays(30));
        Batch batch7 = new Batch(7L, product7,-80.00,-91.2,10205,9990,LocalDate.of(2022,10,1), LocalDateTime.of(LocalDate.of(2022,10,1), LocalTime.now()), LocalDate.now().plusDays(30));
        Batch batch8 = new Batch(8L, product8,-30.00,-50.6,4506,2776,LocalDate.of(2019,8,9), LocalDateTime.of(LocalDate.of(2019,8,9), LocalTime.now()), LocalDate.now().plusDays(30));
        Batch batch9 = new Batch(9L, product9,-12.00,-30.4,888,401,LocalDate.of(2019,5,29), LocalDateTime.of(LocalDate.of(2019,5,29), LocalTime.now()), LocalDate.now().plusDays(30));
        Batch batch10 = new Batch(10L, product10,-22.00,-42.7,343,3,LocalDate.of(2005,11,7), LocalDateTime.of(LocalDate.of(2005,11,7), LocalTime.now()), LocalDate.now().plusDays(30));
        ...
        Batch batch12 = new Batch(11L, product10,-40.00,-50.7,88580,77565,LocalDate.of(2022,7,14), LocalDateTime.of(LocalDate.of(2022,7,14), LocalTime.now()), LocalDate.now().minusDays(100));
