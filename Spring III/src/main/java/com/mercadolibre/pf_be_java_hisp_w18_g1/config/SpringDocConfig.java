...
import static com.mercadolibre.pf_be_java_hisp_w18_g1.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.pf_be_java_hisp_w18_g1.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("ext_caarroyo")
                .email("ext_caarroyo@mercadolibre.com"));
