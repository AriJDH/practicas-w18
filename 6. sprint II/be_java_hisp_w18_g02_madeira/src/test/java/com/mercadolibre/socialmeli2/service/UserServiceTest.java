...
class UserServiceTest {
    ...
    void test0001FollowUserExists(){
        ...
        Map<Integer, User> users = UtilsFactory.loadUsers();
    ...
    void orderTestExists() {
        ...
        List<User> followed = UtilsFactory.getUsers();
        user.setFollowed(new HashSet<>(followed));

        List<UserDtoRes> expectedUserDtos = UtilsFactory.getUsersListDto("name_asc");
    ...
    void orderTestNull() {
        ...
        List<UserDtoRes> expectedUserDtos = UtilsFactory.getUsersListDto("algo");
        UserFollowedListDtoRes expected = new UserFollowedListDtoRes(id, user.getName(), expectedUserDtos);
    ...
    void orderTestNotExists() {
        ...
        List<User> followers = UtilsFactory.getUsers();
    ...
    void orderTestDesc() {
        ...
        List<UserDtoRes> expectedUserDtos = UtilsFactory.getUsersListDto("name_desc");
        SellerFollowerListDtoRes expected = new SellerFollowerListDtoRes(id, seller.getName(), expectedUserDtos);
    ...
    void test0005DateOrderExists() {
        // Arrange
        int userId = 1;
        String order = null;
        User user = UtilsFactory.userWithId(userId);
    ...
    void test0005DateOrderNotExists() {
        // Arrange
        int userId = 1;
    ...
    void test0006DateDesc() {
        // Arrange
        int userId = 1;
        String order = "date_desc";
        LocalDate today = LocalDate.now();
        User user = UtilsFactory.userWithId(userId);
        User seller2 = UtilsFactory.userWithId(2);
        User seller3 = UtilsFactory.userWithId(3);
        Post post1 = UtilsFactory.postWithDate(today);
        Post post2 = UtilsFactory.postWithDate(today.minusDays(2));
        Post post3 = UtilsFactory.postWithDate(today.minusDays(5));
    ...
    void test0008WithinTwoWeeks(){
        ...
        User seller2 = UtilsFactory.userWithId(2);
        User seller3 = UtilsFactory.userWithId(3);
        Post post1 = UtilsFactory.postWithDate(today.plusDays(2));
        Post post2 = UtilsFactory.postWithDate(today.minusDays(2));
        Post post3 = UtilsFactory.postWithDate(today.minusDays(20));
        seller2.addPost(post1);
        seller2.addPost(post2);
        seller3.addPost(post3);
        user.addFollowed(seller2);
