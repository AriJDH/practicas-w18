...
public class IntegrationUser {
    ...
    void beforeEach()
    {
        ...
        userBuyerNotFollower = new User(40, "useer not follower test");
    ...
    @Test
    void integrationFollowUser() throws Exception
    {
    ...
    @Test
    void integrationUnfollowUser() throws Exception
    {
        ResultMatcher expectedStatus = MockMvcResultMatchers.status().isOk();
    ...
    @Test
    void integrationGetFollowersCount() throws Exception
    {
        ResultMatcher expectedStatus = MockMvcResultMatchers.status().isOk();
    ...
    @Test
    void integrationGetFollowedList() throws Exception
    {
        ResultMatcher expectedStatus = MockMvcResultMatchers.status().isOk();
        ResultMatcher expectedContentType = MockMvcResultMatchers.content().contentType(MediaType.APPLICATION_JSON);
    ...
    @Test
    void integrationGetFollowedListWithOrderAsc() throws Exception
    {
        ResultMatcher expectedStatus = MockMvcResultMatchers.status().isOk();
        ResultMatcher expectedContentType = MockMvcResultMatchers.content().contentType(MediaType.APPLICATION_JSON);
    ...
    @Test
    void integrationGetFollowedListWithOrderDesc() throws Exception
    {
        ResultMatcher expectedStatus = MockMvcResultMatchers.status().isOk();
        ResultMatcher expectedContentType = MockMvcResultMatchers.content().contentType(MediaType.APPLICATION_JSON);
        ResultMatcher expectedFollowedFirst = MockMvcResultMatchers.jsonPath(
    ...
    @Test
    void integrationGetFollowersList() throws Exception
    {
        ResultMatcher expectedStatus = MockMvcResultMatchers.status().isOk();
        ResultMatcher expectedContentType = MockMvcResultMatchers.content().contentType(MediaType.APPLICATION_JSON);
    ...
    @Test
    void integrationGetFollowersListWithOrderAsc() throws Exception
    {
        ResultMatcher expectedStatus = MockMvcResultMatchers.status().isOk();
        ResultMatcher expectedContentType = MockMvcResultMatchers.content().contentType(MediaType.APPLICATION_JSON);
    ...
    @Test
    void integrationGetFollowersListWithOrderDesc() throws Exception
    {
        ResultMatcher expectedStatus = MockMvcResultMatchers.status().isOk();
        ResultMatcher expectedContentType = MockMvcResultMatchers.content().contentType(MediaType.APPLICATION_JSON);
        ResultMatcher expectedFollowerFirst = MockMvcResultMatchers.jsonPath(
