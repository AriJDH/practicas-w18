...
public class UserRepositoryImp implements IUserRepository {
    ...
    public String follow(Integer userId, Integer userIdToFollow) {
        ...
        if (seller == null)
            return "User with id:" + userIdToFollow + " not found";

        follower.getFollowed().add(seller);
        seller.getFollowers().add(follower);

        return follower.getUser_name() + " with id: " + userId + " is following -> " + seller.getUser_name() +
    ...
    public String unFollow(Integer userId, Integer userIdToUnfollow) {
        ...
        if (user == null)
            return "User with id:" + userId + " not found";
        if (seller == null)
            return "User with id:" + userIdToUnfollow + " not found";
        user.getFollowed().remove(seller);
        seller.getFollowers().remove(user);
        return user.getUser_name() + " with id: " + userId + " unfollow to -> " + seller.getUser_name() + " with id: " +
                userIdToUnfollow;
    }
