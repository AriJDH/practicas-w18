...
public class UserGenerator {
    ...
    public static User getUserFollowedName() {
        ...
        user.getFollowed().put(user1.getUserId(), user1);
        user.getFollowed().put(user2.getUserId(), user2);
        user.getFollowed().put(user3.getUserId(), user3);
    ...
    /*APARTADO INDIVIDUAL*/
    public static UserFollowedListDTOres userFollowedList() {
        UserDTOres user1 = new UserDTOres(2, "usuario2");
        UserDTOres user2 = new UserDTOres(3, "usuario3");

        UserFollowedListDTOres user = new UserFollowedListDTOres(1, "usuario1", new ArrayList<>(List.of(user1, user2)));

        return user;
    }

    public static UserFollowersListDTOres userFollowerList() {
        UserDTOres user1 = new UserDTOres(1, "usuario1");
        UserDTOres user2 = new UserDTOres(3, "usuario3");

        UserFollowersListDTOres user = new UserFollowersListDTOres(2, "usuario2", new ArrayList<>(List.of(user1, user2)));
