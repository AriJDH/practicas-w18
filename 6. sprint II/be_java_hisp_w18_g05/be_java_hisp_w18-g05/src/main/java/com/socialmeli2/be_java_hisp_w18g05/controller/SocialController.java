package com.socialmeli2.be_java_hisp_w18g05.controller;
...
import com.socialmeli2.be_java_hisp_w18g05.dto.response.SellerPostListDTOResponse;
import com.socialmeli2.be_java_hisp_w18g05.service.IService;
import com.socialmeli2.be_java_hisp_w18g05.service.ServiceImp;
...
public class SocialController {
    ...
    public ResponseEntity<?> follow(@PathVariable @NotNull(message = "User id can not be empty")
                                                  @Min(value = 1, message = "User id must be greater than zero") Integer userId,
                                                  @PathVariable @NotNull(message = "User id can not be empty")
                                                  @Min(value = 2, message = "User id must be greater than zero") Integer userIdToFollow){
