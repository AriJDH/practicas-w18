...
public class ProductDTO {
    ...
    @Pattern(regexp = "[\\w|\\s]+", message = "El nombre del producto no puede contener caracteres especiales.")
    ...
    @Pattern(regexp = "[\\w]+", message = "El tipo del producto no puede contener caracteres especiales.")
    private String type;
    ...
    @Pattern(regexp = "[\\w]+", message = "El color del producto no puede contener caracteres especiales.")
    private String color;
    @Size(max = 80, message= "Las notas del producto no pueden superar los 80 caracteres.")
    @Pattern(regexp = "[\\w|\\s]+", message = "Las notas del producto no pueden contener caracteres especiales.")
