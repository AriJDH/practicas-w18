...
public class UserRepositoryImpl implements IUserRepository {
    ...
    public UserRepositoryImpl() {
        ...
        users.put(2, new UserEntity(2, "Felipe", new ArrayList<>(Arrays.asList(1)), new ArrayList<>(), new ArrayList<>(Arrays.asList(1))));
        ...
        users.put(6, new UserEntity(6, "Florencia", new ArrayList<>(Arrays.asList(4, 3, 6, 1)), new ArrayList<>(), new ArrayList<>()));
