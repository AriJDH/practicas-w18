...
import com.example.socialmeli2.repository.IProductRepository;
...
import com.example.socialmeli2.util.PublicationMapper;
...
public class PublicationServiceImpl implements IPublicationService {
     ...
     * @param order  publication response order by date: "date_asc" = ascending; "date_desc" = descending
    ...
    public UserFollowedPublicationResponse getUserFollowedPublicationsById(Integer userId, String order) {
        ...
        List<PublicationResponse> sortedResponseList;
        sortedResponseList = ListSorterByOrder.publicationSortedByDate(publicationResponseList, order);

        return new UserFollowedPublicationResponse(userId, sortedResponseList);
    }
