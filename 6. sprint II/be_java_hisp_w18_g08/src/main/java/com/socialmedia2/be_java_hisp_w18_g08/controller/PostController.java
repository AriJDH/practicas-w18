...
public class PostController {
    ...
    @PostMapping("/post")
    public ResponseEntity<ResponseMessasgeDto> createPost(@RequestBody PostDtoReq postDTOReq) {
        ResponseMessasgeDto response = new ResponseMessasgeDto(postService.create(postDTOReq), 200, LocalDateTime.now());
