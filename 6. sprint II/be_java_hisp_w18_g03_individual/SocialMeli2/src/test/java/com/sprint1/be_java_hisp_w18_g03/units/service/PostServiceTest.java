...
public class PostServiceTest {
    ...
    public void getPostSellersOk() {
        ...
        //Assert
        assertFalse(sellersPostDTO.getPosts().isEmpty(), "La lista de post no debe venir vacia"); // REPETIDO, VERIFICAR SI PUEDO ELIMINAR


        assertAll(
                () -> assertFalse(sellersPostDTO.getPosts().isEmpty(), "La lista de post entre las dos semanas y la fecha actual no debe ser vacia"),
                () -> assertEquals(2, sellersPostDTO.getPosts().size(), "Solo debe haber un post en la lista filtrada"), // VERIFICAR PORQUE DEVUELVE UN POST
