...
select title as Título from series Series;
...
/* 6 - Mostrar el título de las películas y 
el rating ordenadas por rating en forma ascendente.  */ 

select title
from movies
order by title asc;

/* 7 - Mostrar los títulos de las primeras 
tres películas en la base de datos. */
select title
from movies
limit 3;
...
/* 10 - Mostrar el título y rating de todas las películas 
...
/* 11 - Mostrar a todos los actores cuyos 
nombres empiezan con Sam. */
select * from actors where first_name like 'Sam%';

/* 12 - Mostrar el título de las películas 
que salieron entre el 2004 y 2008. */
select *
from movies
