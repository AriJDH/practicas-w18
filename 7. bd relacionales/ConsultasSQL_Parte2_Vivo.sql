...
-- los premios de las películas con un rating mayor a 7.5 y 
-- con más de dos premios.
SELECT title, rating, awards
FROM movies
WHERE rating >7.5 AND awards >2;

-- Mostrar el título de las películas y el rating ordenadas por 
...
-- Mostrar el título y rating de todas las películas cuyo título 
-- sea de Toy Story.
SELECT title, rating
FROM movies
