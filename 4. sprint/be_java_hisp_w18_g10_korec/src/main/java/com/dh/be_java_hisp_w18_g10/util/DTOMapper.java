...
*/
    ...
    //----------------------------AGREGADO PARA EL INDIVIDUAL------------------------------------
    public static Post mapToPostPromo(PostPromoDTOreq postDTOreq) {
        Post post = new Post();
        ...
        post.setCategory(postDTOreq.getCategory());
        post.setPrice(postDTOreq.getPrice());
        post.setHas_promo(postDTOreq.getHas_promo());
        post.setDiscount(postDTOreq.getDiscount());
    ...
    public static PostDTOres mapTo(Post post) {
        ...
        // postRes.setHas_promo(post.getHas_promo());
        // postRes.setDiscount(post.getDiscount());
        return postRes;
    }

    //--------------------------------AGREGADO PARA EL INDIVIDUAL--------------------------------
    public static PostPromoDTOres mapToPromo(Post post) {
