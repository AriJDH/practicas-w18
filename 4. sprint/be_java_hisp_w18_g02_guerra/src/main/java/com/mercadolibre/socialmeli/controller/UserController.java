...
public class UserController {
     ...
     * US0010
     * Add Post with Promo
     * @param promoPostDtoReq PromoPost
     * @return 200 OK
     *         400 Bad Request (ErrorDTO Error details)
     */
    ...
    /**
     * US0011
     * Count Seller's Promos
     * @param user_id User ID
     * @return 200 OK (SellerPromoCountDtoRes Number of seller's promos)
     *         400 Bad Request (ErrorDTO Error details)
     */
    @GetMapping("/products/promo-post/count")
    public ResponseEntity<?> getCountPromoPosts(@RequestParam Integer user_id){
        return ResponseEntity.ok(userService.getPromoCount(user_id));
     ...
     * @param user_id User ID
     * @return 200 OK (SellerPromoListDtoRes List of Seller's promo posts)
     *         400 Bad Request (ErrorDTO Error details)
     */
    @GetMapping("/products/promo-post/list")
    public ResponseEntity<?> getListPromoPosts(@RequestParam Integer user_id){
        return ResponseEntity.ok(userService.getPromoPosts(user_id));
     ...
     * @param user_id User ID
     * @param order (optional) date_asc / date_desc
     * @return 200 OK (SellerPromoListDtoRes List of Seller's posts)
     *         400 Bad Request (ErrorDTO Error details)
     */
    @GetMapping("/products/post/list")
    public ResponseEntity<?> getAllSellerPosts(@RequestParam Integer user_id,
                                               @RequestParam(required = false) String order){
        return ResponseEntity.ok(userService.getSellerPosts(user_id,order));

    }

    /**
     * US0014
     * Get Top 5 Sellers most followed
     * @return 200 OK (TopSellerDtoRes List of Top Sellers)
     *         400 Bad Request (ErrorDTO Error details)
     */
    @GetMapping("/products/user/toplist")
    public ResponseEntity<?> getAllSellerPosts(){
