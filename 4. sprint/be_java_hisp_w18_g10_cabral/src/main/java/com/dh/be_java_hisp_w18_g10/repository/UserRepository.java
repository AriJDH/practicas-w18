...
public class UserRepository implements IUserRepository{
    ...
    private List<Post> getListPosts(){
        ...
        Post post1 = new Post(2,4, old, getListProduct().get(0),23,340.00, false, 0.3);
        Post post2 = new Post(2,5, lastWeek, getListProduct().get(1),4,456,true,0.5);
        Post post3 = new Post(2,6, LocalDate.now(),getListProduct().get(2),77,865,false,0.2);
        return List.of(post1,post2,post3);
    }
    private List<Product> getListProduct(){
        Product product = new Product(1,"Buzo","Ropa","Nike","Gris","Para usar en invierno");
        Product product2 = new Product(2,"Pantalon","Ropa","Adida","Negro","Para usar en Otoño");
