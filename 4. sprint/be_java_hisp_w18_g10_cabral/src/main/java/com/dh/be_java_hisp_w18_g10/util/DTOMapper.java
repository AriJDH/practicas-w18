...
public class DTOMapper {
    ...
    public static Post mapToPost(PostPromoDTOReq postPromoDTOReq){
        Post post = new Post();
        post.setUserId(postPromoDTOReq.getUser_id());
        post.setDate(DateHandler.StringToDate(postPromoDTOReq.getDate()));
        Product product = getInstance().map(postPromoDTOReq.getProduct(), Product.class);
        product.setProductId(postPromoDTOReq.getProduct().getProduct_id());
        product.setProductName(postPromoDTOReq.getProduct().getProduct_name());
        post.setProduct(product);
        post.setCategory(postPromoDTOReq.getCategory());
        post.setPrice(postPromoDTOReq.getPrice());
        post.setHas_promo(postPromoDTOReq.isHas_promo());
        post.setDiscount(postPromoDTOReq.getDiscount());
        return post;
    }

    public static Post mapToPost(PostPromoDTOres postPromoDTOres){
        Post post = new Post();
        post.setUserId(postPromoDTOres.getUser_id());
        post.setDate(DateHandler.StringToDate(postPromoDTOres.getDate()));
        Product product = getInstance().map(postPromoDTOres.getProduct(), Product.class);
        product.setProductId(postPromoDTOres.getProduct().getProduct_id());
        product.setProductName(postPromoDTOres.getProduct().getProduct_name());
        post.setProduct(product);
        post.setCategory(postPromoDTOres.getCategory());
        post.setPrice(postPromoDTOres.getPrice());
        post.setHas_promo(postPromoDTOres.isHas_promo());
        post.setDiscount(postPromoDTOres.getDiscount());
        return post;
    }
    ...
    public static PostPromoDTOres mapToPostPromo(Post post){
        PostPromoDTOres postRes = new PostPromoDTOres();
        postRes.setUser_id(post.getUserId());
        postRes.setPost_id(post.getPost_id());
        //Parse fecha, ya que el DTO la maneja como String
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd-MM-yyyy");
        ...
        //Fin mapeo
        postRes.setCategory(post.getCategory());
        postRes.setHas_promo(post.isHas_promo());
        postRes.setDiscount(post.getDiscount());
        return postRes;
    }
