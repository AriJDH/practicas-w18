...
public class ExceptionConfig {
    ...
    @ExceptionHandler
    public ResponseEntity<ErrorExceptionDTOResponse> notPromoException(NotPromoException notPromoException){
        return new ResponseEntity<>(
                new ErrorExceptionDTOResponse(notPromoException.getMessage(), HttpStatus.BAD_REQUEST.value()),
                HttpStatus.BAD_REQUEST);
