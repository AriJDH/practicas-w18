...
public class UserRepository implements IUserRepository{
    ...
    private void loadUsers(){
        ...
        Map<Integer, User> followersUser1 = new HashMap<Integer, User>();
        followedUsuer1.put(user4.getUserId(), user4);
        followedUsuer1.put(user5.getUserId(), user5);
        user1.setFollowers(followersUser1);
