...
public class ProductsController {
    ...
    public ResponseEntity<HttpStatus> savePromo(@RequestBody PromoPostRequest promoPostRequest){
        return new ResponseEntity<>(postService.savePromo(promoPostRequest));
    }

    @PostMapping("/promo-post/disable")
    public ResponseEntity<HttpStatus> disablePromo(@RequestParam(name = "promo_id") Integer promoId){
        return new ResponseEntity<>(postService.disablePromo(promoId));
    }
