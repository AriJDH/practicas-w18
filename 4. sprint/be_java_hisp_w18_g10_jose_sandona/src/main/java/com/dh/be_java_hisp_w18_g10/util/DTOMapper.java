...
public class DTOMapper {
    ...
    public static PostPromotion mapTo(PostPromotionDTOreq postPromotionDTOreq){
        PostPromotion postPromotion = new PostPromotion();
        postPromotion.setUserId(postPromotionDTOreq.getUser_id());
        postPromotion.setDate(DateHandler.StringToDate(postPromotionDTOreq.getDate()));
        Product product = getInstance().map(postPromotionDTOreq.getProduct(), Product.class);
        product.setProductId(postPromotionDTOreq.getProduct().getProduct_id());
        product.setProductName(postPromotionDTOreq.getProduct().getProduct_name());
        postPromotion.setProduct(product);
        postPromotion.setCategory(postPromotionDTOreq.getCategory());
        postPromotion.setPrice(postPromotionDTOreq.getPrice());
        postPromotion.setHasPromo(postPromotionDTOreq.isHasPromo());
        postPromotion.setDiscount(postPromotionDTOreq.getDiscount());
