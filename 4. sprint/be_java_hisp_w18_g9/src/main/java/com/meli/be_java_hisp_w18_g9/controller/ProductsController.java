...
public class ProductsController {
    ...
    public ResponseEntity<PromoProductsCountResponse> countPromoByUserId(@RequestParam("user_id") Integer userId){
    ...
    public ResponseEntity<PromoPostListByUserResponse> findPromoByUserId(@RequestParam("user_id") Integer userId){
    ...
    public ResponseEntity savePromo(@RequestBody PromoPostRequest promoPostRequest){
